...
def lambda_handler(event, context):
    ...
    for record in event['records']:
        ...
        # Data send throught firehose
        data = {
                "order_id": json_payload['order_id'],
                "payment_type": json_payload['purchaise_details']['payment_type'],
                "amount": json_payload['purchaise_details']['amount'],
                "currency": json_payload['purchaise_details']['currency'],
                "instalments": json_payload['purchaise_details']['instalments']
        }
